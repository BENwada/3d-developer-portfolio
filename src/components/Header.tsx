...
const navmenu = ["Home", "About", "Projects", "Experience", "Contact"];
const socilaLinks = [
  ...
  return (
    <header className="absolute w-full z-50 transition-all duration-300">
      ...
      <motion.div
        ...
        className="md:hidden overflow-hidden gb-white dark:bg-gray-900 shadow-lg px-4 py-5 space-y-5"
      >
          ...
          <div className="flex space-x-5">
            {socilaLinks.map((item, index) => (
              <a key={index} href={item.href}>
                <span className="w-5 h-5 text-gray-300">{item.icon}</span>
              </a>
            ))}
          </div>
          <button
