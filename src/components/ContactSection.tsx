  ...
  return (
    ...
    >
      ...
      >
        ...
        >
          <h1 className="text-black md:w-[10rem] w-[20rem] lg:scale-[0.4] sm:scale-[0.07] md:font-bold text-md sm:text-base leading-none mb-5">
          ...
          <p className="text-black lg:w-[40rem] w-[20rem] absolute sm:mt-3 mt-1 md:scale-[0.1] scale-[0.068]">
            Front-end developer specialized in crafting modern, respnsive web
            interfaces using React, Tailwind CSS, and advanced UI animation
            techniques. Focused on clean code, and pixel-prefect design that
            stand out.
          </p>
